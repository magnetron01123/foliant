...
Raspberry Pi 4: 19 502 Einträge aus 34 Quellen (dt. SRD 5.2.1, sechs deutsche 2014-Bücher,
...
`https://<host>/<token>/foliant`, kein OAuth. Einrichten am Desktop; benutzen geht danach auch aus
