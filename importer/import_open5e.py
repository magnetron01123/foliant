...
# Facetten (zauber_meta/monster_meta) schreibt seit 28.07.2026 ausschliesslich
# importer/facetten_seeder.py - fuer ALLE Quellen und in EINEM Wertraum. Der fruehere
# Open5e-Sonderweg schrieb aus den nativen API-Feldern und damit anders als der Rest
# des Codes rechnet (hg "10.0" statt kanonisch "10", schule "Evocation" statt
# "hervorrufung") - die Meta-Tabelle widersprach der Filterlogik in app/facetten.py.
