...
| **Rest-Streuung im Antwortgerüst: rund 2 von 24 Fällen je Volllauf** | niedrig | Seit die Struktur gemessen statt begutachtet wird (07./08.08.2026), sind die systematischen Verstöße behoben — drei Volllaufe in Folge zeigten 3, 3 und 2 harte FAILs, jedes Mal **andere** Fälle. Das ist Streuung um ~90 % Regeltreue je Fall, kein Defekt. Weitere Prompt-Verschärfungen haben erkennbar abnehmenden Ertrag und verdünnen die übrigen Regeln; nächster Schritt wäre eine Messreihe über mehrere Läufe statt eine weitere Regel |
