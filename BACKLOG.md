...
**Stand: 08.08.2026 · MVP komplett und live.** Was noch zwischen „läuft" und „meine Runde
...
| **Rest-Streuung im Antwortgerüst** | niedrig | Die Aggregation über vier Volllaufe (08.08.2026) zeigte: Was wie Streuung aussah, waren zwei Restlücken — die Optionslisten trugen als einziger Auskunftsweg die Kopfzeilen-Regel nicht (C3, DC4), und bei „Welche X hat Y?" eröffnete das Modell mit dem Antwortsatz statt der Kopfzeile. Beides geschlossen (Kanal-3-Hinweise + Muster-Beispiel statt weiterer Regel); Messreihen danach: C3/DC2/DC3 je 3/3 grün, DC4 5/5, Volllauf **0 harte FAILs von 24**. Beobachtung im nächsten Rückmeldungs-Durchgang fortführen — ein grüner Volllauf ist eine Stichprobe, kein Beweis |
