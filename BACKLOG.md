...
| Drei weiche Richter-Urteile im Volllauf 06.08.2026: Statblock-Abschnitte in falscher Reihenfolge (B3), eine Ableitung ohne Kennzeichnung (D1), Unterklassen-Liste als Fließtext statt Menü (DC4) | niedrig | Keine harten FAILs — die deterministischen Marker sitzen, beanstandet hat sie der LLM-Richter. Einzeln zu klären im nächsten Rückmeldungs-Durchgang (M5); DC4 ist der Wiedergänger des Befunds vom 01.08.2026 |
